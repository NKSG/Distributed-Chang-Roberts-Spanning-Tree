...
${OBJECTDIR}/LinkedList.o: LinkedList.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/LinkedList.o LinkedList.c

${OBJECTDIR}/Queue.o: Queue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Queue.o Queue.c

${OBJECTDIR}/Simulation.o: Simulation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Simulation.o Simulation.c

${OBJECTDIR}/CommunicationProtocol.o: CommunicationProtocol.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/CommunicationProtocol.o CommunicationProtocol.c

${OBJECTDIR}/Network-Topology.o: Network-Topology.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Network-Topology.o Network-Topology.c

${OBJECTDIR}/FileOperations.o: FileOperations.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileOperations.o FileOperations.c
...
${TESTDIR}/tests/TestCommunicationProtocol.o: tests/TestCommunicationProtocol.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/TestCommunicationProtocol.o tests/TestCommunicationProtocol.c
...
${OBJECTDIR}/LinkedList_nomain.o: ${OBJECTDIR}/LinkedList.o LinkedList.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/LinkedList_nomain.o LinkedList.c;\
	else  \
...
${OBJECTDIR}/Queue_nomain.o: ${OBJECTDIR}/Queue.o Queue.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Queue_nomain.o Queue.c;\
	else  \
...
${OBJECTDIR}/Simulation_nomain.o: ${OBJECTDIR}/Simulation.o Simulation.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Simulation_nomain.o Simulation.c;\
	else  \
...
${OBJECTDIR}/CommunicationProtocol_nomain.o: ${OBJECTDIR}/CommunicationProtocol.o CommunicationProtocol.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/CommunicationProtocol_nomain.o CommunicationProtocol.c;\
	else  \
...
${OBJECTDIR}/Network-Topology_nomain.o: ${OBJECTDIR}/Network-Topology.o Network-Topology.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Network-Topology_nomain.o Network-Topology.c;\
	else  \
...
${OBJECTDIR}/FileOperations_nomain.o: ${OBJECTDIR}/FileOperations.o FileOperations.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileOperations_nomain.o FileOperations.c;\
	else  \
